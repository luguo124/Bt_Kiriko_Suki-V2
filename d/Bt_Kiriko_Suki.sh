...
Bt_Umaru_Pro_5.9.1_y(){
# 就这么简单呀~   
    apt-get install wget && wget -O update.sh $umaru_Url/install/update_pro.sh && bash update.sh pro
	rm -rf update.sh
	main
}
...
Bt_Umaru_Pro_5.9.1_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/5.9.1/install-ubuntu.sh && bash install.sh
	rm -rf install.sh
	main
}
...
Bt_Umaru_Pro_6.8.9_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/6.8.9/install-ubuntu_6.0.sh && bash install.sh
	rm -rf install.sh
	main
}
...
# 宝塔 6.9.0 安装 centos面板
	Bt_Umaru_Pro_6.9.0_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/6.9.0/install-ubuntu_6.0.sh && bash install.sh
	rm -rf install.sh
	main
}
...
# 宝塔 6.9.1 安装 centos面板
	Bt_Umaru_Pro_6.9.1_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/6.9.1/install-ubuntu_6.0.sh && bash install.sh
	rm -rf install.sh
	main
}
...
Bt_Umaru_Pro_6.9.2_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/6.9.2/install-ubuntu_6.0.sh && bash install.sh
	rm -rf install.sh
	main
}
...
# 宝塔 6.9.3 安装 centos面板
	Bt_Umaru_Pro_6.9.3_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/6.9.3/install-ubuntu_6.0.sh && bash install.sh
	rm -rf install.sh
	main
}
...
# 宝塔 6.9.4 安装 centos面板
	Bt_Umaru_Pro_6.9.4_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/install-ubuntu_6.0.sh && bash install.sh
	rm -rf install.sh
	main
}
...
# 对象存储挂载工具(OSS/COS)
	wget -O install.sh $umaru_Url/d/install/plugin/ossfs/install.sh && chmod 755 install.sh && bash install.sh install
	rm -rf install.sh
...
# OpenFogOS
	mkdir -p $pluginPath8
	wget -O openfog_installer.sh $umaru_Url/install/plugin/openfogos/openfog_installer.sh && chmod 755 openfog_installer.sh && bash openfog_installer.sh
	wget -O install.sh $umaru_Url/install/plugin/openfogos/install.sh && chmod 755 install.sh && bash install.sh install
	rm -rf install.sh
...
# 安装 Beta 版面板
beta(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/ubuntu_beta.sh && bash install.sh
	rm -rf install.sh
	main
}
