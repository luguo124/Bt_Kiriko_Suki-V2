...
Byebye="${Red_font}感谢使用书记的脚本!!!\n更多内容请关注 → Loli分享论坛：www.moecat.cn 雾子の博客（原：樱花博客）：www.kiriko.org ！${Font_suffix}"
...
pluginPath8=/www/server/panel/plugin/openfogos
...
Beta="${Red_font}[宝塔 6.9.19 Beta]${Font_suffix}"
...
Bt_Umaru_Pro_5.9.1_y(){
# 就这么简单呀~   
    apt-get install wget && wget -O update.sh $umaru_Url/install/update_pro.sh && sudo bash update.sh pro
	rm -rf update.sh
	main
}
...
Bt_Umaru_Pro_5.9.1_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/5.9.1/install-ubuntu.sh && sudo bash install.sh
	rm -rf install.sh
	main
}
...
Bt_Umaru_Pro_6.8.9_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/6.8.9/install-ubuntu_6.0.sh && sudo bash install.sh
	rm -rf install.sh
	main
}
...
# 宝塔 6.9.0 安装 centos面板
	Bt_Umaru_Pro_6.9.0_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/6.9.0/install-ubuntu_6.0.sh && sudo bash install.sh
	rm -rf install.sh
	main
}
...
# 宝塔 6.9.1 安装 centos面板
	Bt_Umaru_Pro_6.9.1_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/6.9.1/install-ubuntu_6.0.sh && sudo bash install.sh
	rm -rf install.sh
	main
}
...
Bt_Umaru_Pro_6.9.2_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/6.9.2/install-ubuntu_6.0.sh && sudo bash install.sh
	rm -rf install.sh
	main
}
...
# 宝塔 6.9.3 安装 centos面板
	Bt_Umaru_Pro_6.9.3_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/6.9.3/install-ubuntu_6.0.sh && sudo bash install.sh
	rm -rf install.sh
	main
}
...
# 宝塔 6.9.4 安装 centos面板
	Bt_Umaru_Pro_6.9.4_centos(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/install-ubuntu_6.0.sh && sudo bash install.sh
	rm -rf install.sh
	main
}
...
plugin_all_n(){
# 网页防篡改程序
	wget -O install.sh $umaru_Url/install/plugin/tamper_proof/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh

# 宝塔系统加固
	wget -O install.sh $umaru_Url/install/plugin/syssafe/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh

# 网站监控报表
	wget -O install.sh $umaru_Url/install/plugin/total/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh

# Nginx防火墙
	wget -O install.sh $umaru_Url/install/plugin/btwaf/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh

# 宝塔负载均衡
	wget -O install.sh $umaru_Url/install/plugin/load_leveling/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh

# MYSQL主从复制
	wget -O install.sh $umaru_Url/install/plugin/masterslave/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh

# 宝塔任务管理器
	wget -O install.sh $umaru_Url/install/plugin/task_manager/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh

# 微信小程序
	wget -O install.sh $umaru_Url/install/plugin/app/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh

# 异常监控推送
	wget -O install.sh $umaru_Url/install/plugin/msg_push/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh

# 数据同步工具
	wget -O install.sh $umaru_Url/install/plugin/rsync/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh

# 宝塔安全登录
	wget -O install.sh $umaru_Url/install/plugin/safelogin/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh
...
# Apache防火墙
	wget -O install.sh $umaru_Url/install/plugin/btwaf_httpd/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh
...
#          2.宝塔系统加固 2.2
#          3.网站监控报表 2.7
#          4.Apache防火墙 6.3 ${fuli}
#          5.Nginx防火墙 6.9.9 ${fuli}
#          6.宝塔负载均衡 1.5
#          7.MYSQL主从复制 2.1
#          8.宝塔任务管理器 1.3
#          9.微信小程序 1.8
...
# SSH秘钥管理器
	wget -O install.sh $umaru_Url/install/plugin/sshkey/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh
	\cp -a -r /www/server/panel/plugin/sshkey/icon.png /www/server/panel/BTPanel/static/img/soft_ico/ico-sshkey.png

# 对象存储挂载工具(OSS/COS)
	wget -O install.sh $umaru_Url/d/install/plugin/ossfs/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh
...
# 文件共享管理器
	wget -O install.sh $umaru_Url/install/plugin/nfsserver/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh
...
# 磁盘挂载工具
	mkdir -p $pluginPath5
	echo '正在安装脚本文件...' > $install_tmp
	wget -O install.sh $umaru_Url/install/plugin/disk/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh
...
# 域名解析助手
    mkdir -p $pluginPath3
	wget -O install.sh $umaru_Url/install/plugin/domains/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh
...
# 微擎助手
    mkdir -p $pluginPath6
	wget -O install.sh $umaru_Url/install/plugin/w7assistant/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh
...
# 钟馗风控薅羊毛手机号识别
    mkdir -p $pluginPath7
	wget -O install.sh $umaru_Url/install/plugin/qiankeji/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh
...
# OpenFogOS
	mkdir -p $pluginPath8
	wget -O openfog_installer.sh $umaru_Url/install/plugin/openfogos/openfog_installer.sh && chmod 755 openfog_installer.sh && sudo bash openfog_installer.sh
	wget -O install.sh $umaru_Url/install/plugin/openfogos/install.sh && chmod 755 install.sh && sudo bash install.sh install
	rm -rf install.sh
	rm -rf openfog_installer.sh
	\cp -a -r /www/server/panel/plugin/openfogos/icon.png /www/server/panel/BTPanel/static/img/soft_ico/ico-openfogos.png
...
# 安装 Beta 版面板
beta(){
	apt-get install wget && wget -O install.sh $umaru_Url/install/ubuntu_beta.sh && sudo bash install.sh
	rm -rf install.sh
	main
}
...
# 修复 install.sh: No such file or directory 报错
free(){
	clear
	cd /root
	wget https://umaru.uk/resolv.conf
	rm -rf /etc/resolv.conf
	cp -pf /root/resolv.conf /etc/resolv.conf
	cd /
	rm -rf /root/resolv.conf
	echo -e "${Info} DNS 修复成功！ 请输入 'reboot' 重启小鸡 在重新下载脚本！"
	echo -e "${Info} 若是 修复重启之后 还是出现 install.sh: No such file or directory \n请检查 etc/esolv.conf 里的内容 是否为：\nnameserver 8.8.8.8\nnameserver 8.8.4.4 \n"
}
